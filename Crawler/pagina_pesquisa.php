...
echo $html = '<html>';
echo $html = '<head>';
echo $html = '<title>Pesquisa de Texto</title>';
...
echo $html = '<form class="form-container" action="queries/resultados_texto.php" method="post">';
echo $html = '<div class="strong-class">';
echo $html = '<strong id="strong-pesquisa">Pequisar</strong></br>';
echo $html = '</div>';
echo $html = '<input id="input-text" placeholder="Insira uma uma palavra" type="text" name="pesquisa">';
